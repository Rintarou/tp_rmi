...
java -cp bin -Djava.security.policy=client.policy -Djava.rmi.server.codebase="file:///hometu/etudiants/b/a/E145773Z/rmitmp/git/tp_rmi/rmi2sport/bin" serveur.TestServeurRmi
